...
#include "AbilityTask_SpawnGameplayActor.generated.h"
...
UCLASS()
class SOC_API UAbilityTask_SpawnGameplayActor: public UAbilityTask
{
	...
	static UAbilityTask_SpawnGameplayActor* SpawnGameplayActor(UGameplayAbility* OwningAbility, FGameplayAbilityTargetDataHandle TargetData, TSubclassOf<AActor> Class);
